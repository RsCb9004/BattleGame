namespace BattleGame {
    ...
    public static class ConsoleUI {
        ...
        public static void PrintIntoLine(string text = "") {
            ResetColor();
            for(int i = 0; i < text.Length; i++) {
        ...
        public static void PrintIntoLineAt(int line, string text = "") {
        ...
        private static int GetWidth() => Console.BufferWidth - Console.CursorLeft;
